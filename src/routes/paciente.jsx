...
const CadastroPaciente = () => {
    return (
        <div className="v18_2">
            ...
            <span className="v18_26"><a href="dashboard.html">Dashboard</a></span>
            ...
            <div className="v25_27">
                <input type="text" className="input-text" placeholder="Digite o nome do paciente" />
            </div>
            <span className="v25_28">CPF *</span>
            <div className="v25_31">
                <input type="text" className="input-text" placeholder="Digite o CPF do paciente" />
            </div>
            ...
            <div className="v25_49">
                <input type="text" className="input-text" placeholder="Digite o email" />
            </div>
            <span className="v25_50">Nome da mãe *</span>
            <div className="v25_51">
                <input type="text" className="input-text" placeholder="Digite o nome da mãe do paciente" />
            </div>
            ...
            <div className="v25_58">
                <input type="text" className="input-text" placeholder="Digite a Cidade" />
            </div>
            <span className="v25_59">Endereço *</span>
            <div className="v25_60">
                <input type="text" className="input-text" placeholder="Digite o Endereço" />
            </div>
            ...
            <div className="v234_4">
                <input type="text" className="input-text" placeholder="Digite a Microárea" />
            </div>
        </div>
    );
}
